...
public class CustomerReview {
    ...
    public CustomerReview(String revId, String sentId, String l3, String sentiment,
    ...
    public boolean equals(final CustomerReview customerReview) {
        if(this.getId().equals(customerReview.getId()))
            return true;
        else
            return false;
    }
